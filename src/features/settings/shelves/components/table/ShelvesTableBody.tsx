...
export function ShelvesTableBody({ table, columns, isLoading, search, messages }: any) {
  return (
    <>
      <TableHeader>
      ...
      <TableBody>
        {isLoading ? (
          ...
          <TableNoResults
            ...
            message={search ? messages("Shelves.noSearchResults") : messages("Shelves.noResults")}
          />
        )}
      </TableBody>
    </>
