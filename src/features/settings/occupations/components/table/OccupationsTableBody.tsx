...
export function OccupationsTableBody({ table, columns, isLoading, search, messages }: any) {
  return (
    <>
      <TableHeader>
      ...
      <TableBody>
        {isLoading ? (
          ...
          <TableNoResults
            ...
            message={search ? messages("Occupations.noSearchResults") : messages("Occupations.noResults")}
          />
        )}
      </TableBody>
    </>
