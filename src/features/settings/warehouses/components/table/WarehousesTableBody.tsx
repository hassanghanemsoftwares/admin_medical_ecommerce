...
export function WarehousesTableBody({ table, columns, isLoading, search, messages }: any) {
  return (
    <>
      <TableHeader>
      ...
      <TableBody>
        {isLoading ? (
          ...
          <TableNoResults
            ...
            message={search ? messages("Warehouses.noSearchResults") : messages("Warehouses.noResults")}
          />
        )}
      </TableBody>
    </>
