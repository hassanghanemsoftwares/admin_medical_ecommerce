...
type UseColorSeasonColumnsProps = {
  handleEdit: (colorSeason: ColorSeason) => void;
  handleDelete: (colorSeason: ColorSeason) => void;
};

export function useColorSeasonColumns({ handleEdit, handleDelete }: UseColorSeasonColumnsProps): ColumnDef<ColorSeason>[] {
