...
export function ColorSeasonsTableBody({ table, columns, isLoading, search, messages }: any) {
  return (
    <>
      <TableHeader>
      ...
      <TableBody>
        {isLoading ? (
          ...
          <TableNoResults
            ...
            message={search ? messages("ColorSeasons.noSearchResults") : messages("ColorSeasons.noResults")}
          />
        )}
      </TableBody>
    </>
