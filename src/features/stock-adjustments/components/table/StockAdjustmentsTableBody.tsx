...
export function StockAdjustmentsTableBody({ table, columns, isLoading, search, messages }: any) {
  return (
    <>
      <TableHeader>
      ...
      <TableBody>
        {isLoading ? (
          ...
          <TableNoResults
            ...
            message={
              search
                ? messages("StockAdjustments.No search results")
                : messages("StockAdjustments.No logs found")
            }
          />
        )}
      </TableBody>
